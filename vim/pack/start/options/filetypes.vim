...
au BufAdd,BufRead,BufEnter,BufWinEnter *.F,*inc.hotb :nmap <buffer> <F9> :call BuildHotbClean()<CR>
au BufAdd,BufRead,BufEnter,BufWinEnter *.F,*inc.hotb :nmap <buffer> <F10> :call BuildHotb()<CR>
...
" au BufAdd,BufRead,BufEnter,BufWinEnter *.F :let b:dispatch='cd ~/hotb/ && make clean && make -j8 WITH_OPENMP=1 && cd -'
